...
| `memory_search`      | Search my memories using multi-signal ranking (vector similarity, recency, graph context, instance affinity). Falls back to text matching if embeddings are unavailable.                                                                                                                                                                                                                                                                 |
...
See [sync-and-memory.md](./sync-and-memory/) for the memory hierarchy and
...
See [sync-and-memory.md](./sync-and-memory/) for the sync protocol and conflict
resolution details.
...
See [snapshots.md](./snapshots/) for retention policies and restore procedures.
...
See [knowledge-graph.md](./knowledge-graph/) for node types, edge types,
